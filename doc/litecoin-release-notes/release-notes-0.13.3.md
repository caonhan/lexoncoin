Lexoncoin Core version 0.13.3 is now available from:

  <https://download.lexoncoin.org/lexoncoin-0.13.3/>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/lexoncoin-project/lexoncoin/blob/0.13/src/chainparams.cpp#L214).
