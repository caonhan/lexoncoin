...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/lexoncoin-project/lexoncoin>";
    const std::string URL_WEBSITE = "<https://lexoncoin.org>";
