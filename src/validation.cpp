...
#if defined(NDEBUG)
# error "Lexoncoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Lexoncoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s LXG additional fees, %d delta bytes\n",
