...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s lexoncoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  lexoncoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded lexoncoin transaction") + "\n" +
              "  lexoncoin-tx [options] -create [commands]   " + _("Create hex-encoded lexoncoin transaction") + "\n" +
              "\n";
